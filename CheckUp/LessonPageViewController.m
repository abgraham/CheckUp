...
- (void)viewDidLoad {
    ...
    [self.image setImage:[UIImage imageNamed:@"sugar1.jpg"]];
        ...
        [self.image setImage:[UIImage imageNamed:@"sugar2.jpg"]];
        ...
        [self.image setImage:[UIImage imageNamed:@"sugar3.jpg"]];
        ...
        appDelegate.hasTakenSugarLesson = YES;
        ...
        [self.image setImage:[UIImage imageNamed:@"healthydiet1.jpeg"]];
        ...
        [self.image setImage:[UIImage imageNamed:@"healthydiet2.jpeg"]];
        ...
        [self.image setImage:[UIImage imageNamed:@"healthydiet3.jpeg"]];
        ...
        [self.image setImage:[UIImage imageNamed:@"healthydiet4.jpeg"]];
